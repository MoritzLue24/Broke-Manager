...
namespace Api.Services.Keywords
{
    public interface IKeywordService
    {
        ...
        /// <exception cref="KeyNotFoundException">If the category does not exist / is not owned by given user</exception>
        ...
        /// <exception cref="KeyNotFoundException">If the keyword does not exist / is not owned by given user OR the keyword is not from given category</exception>
        ...
        /// <returns>Async task</returns>
        /// <exception cref="KeyNotFoundException">If the category does not exist / is not owned by given user OR if the keyword is not from given category</exception>
